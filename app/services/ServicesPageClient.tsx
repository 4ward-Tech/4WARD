...
import { Service, Project, Testimonial } from "@prisma/client";
...
export default function ServicesPageClient({ 
    ...
    const leftServices = initialServices.slice(0, 2);
    const rightServices = initialServices.slice(2, 4);
                    ...
                    <div className="flex flex-col items-center md:items-end gap-10 md:gap-32 md:pt-16 z-10 relative">
                        {leftServices.map((svc, i) => (
                            <ServiceBox 
                                ...
                                delay={0.1 + i * 0.1}
                                number={svc.order.toString().padStart(2, '0')}
                            />
                        ))}
                    </div>
                ...
                {initialTestimonial && (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-4 pl-6">
                            ...
                            <div>
                                <h4 className="font-black text-xs uppercase tracking-tight text-[#1a1a1a]">{initialTestimonial.name}</h4>
                                <p className="text-[9px] uppercase tracking-[0.2em] text-[#1a1a1a]/40 font-bold">{initialTestimonial.role}</p>
                            </div>
                        </div>
                    </motion.div>
                )}
